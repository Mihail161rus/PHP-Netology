...
<body>
    ...
    ?>
    <div class="auth-form">
        <p>Для прохождения тестов достаточно ввести только имя в поле логин, если нужно загрузить/удалить тесты, то необходимо авторизоваться под Администратором
        </p>
